...
class WorldCupSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $usersData = [
            ['name' => 'Hugo Hugo',       'email' => 'hugo@quiniela.com',   'points' => 0],
            ['name' => 'Sofía Pérez',     'email' => 'sofia@quiniela.com',  'points' => 0],
            ['name' => 'Carlos Mendoza',  'email' => 'carlos@quiniela.com', 'points' => 0],
            ['name' => 'Ana Rodríguez',   'email' => 'ana@quiniela.com',    'points' => 0],
        ];
